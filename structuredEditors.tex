...
\textbf{Card:}As a Professor, you want define a grammar and allow students to create trees in this grammar so students can understand the set of legal trees in a grammar.
...
\textbf{Card:}As a Researcher you want to be able to apply probability technique over ASTs so that you can justify your claims that this is useful for code editors.
...
\section{User Stories}
\textbf{Card:}As a Researcher, you want an environment to trees based on some characteristic so to better understand the probability.
